...
struct User {
    ...
    static var currentUser =  User(userName: "Gupil", email: "gupil@gmail.com", age: 19)
 ...
 */
let newUser = User(userName: "NewUser", email: "newuser@example.com", age: 30)
User.logIn(user: newUser)
print("Current Username: \(User.currentUser.userName)")
