 ...
 */
let nameInCaps = "Ankit Bansal"
let name = "ankit bansal"
...
let searchThrough = textToSearchThrough.lowercased()
let searchFor = textToSearchFor.lowercased()

if (searchThrough.contains(searchFor)) {
    print("I found it!")
}
