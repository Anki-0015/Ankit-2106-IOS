...
let myRun = RunningWorkout(distance: 2500, time: 60, elevation: 100)
print("Average mile time: \(myRun.averageMileTime) seconds")
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print( "Congratulations! You've taken your daily step goal!")
            }
        }
    }
    var goal: Int
