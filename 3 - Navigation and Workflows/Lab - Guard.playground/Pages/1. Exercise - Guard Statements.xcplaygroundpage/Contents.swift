...
print(calculateArea(x: 5.0, y: 10.0) ?? "Invalid input")
print(calculateArea(x: -3.0, y: 10.0) ?? "Invalid input")
...
print(add(3, 4) ?? "One or both values are nil")
print(add(nil, 4) ?? "One or both values are nil")
